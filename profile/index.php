  ...
  <div class="container">
    ...
    <form action="#">
      <div class="user-details">
        ...
        <div class="input-box">
          <label for="email-id" class="details">Email ID</label>
          <input id="email-id" type="email" placeholder="Enter your email" required />
        </div>
        <div class="input-box">
          <label for="phone-number" class="details">Phone Number</label>
          <input id="phone-number" type="tel" placeholder="Enter your phone number" required />
        </div>
      </div>
      <div class="button">
