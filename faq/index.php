<?php require_once "../partials/header.php"; ?>
    ...
    <div class="faq-container">
        <section id="faq">
            ...
            <div class="faq-item">
                <button class="faq-question">What is the Student Accommodation Management System by Student Shelters?</button>
                <div class="faq-answer">
                    <p>The Student Accommodation Management System (SAMS) by Student Shelters is a web application designed to help students find, manage, and rent accommodation easily and securely.</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>Our platform is designed for students, property managers, landlords, and educational institutions.</p>
                </div>
            </div>
